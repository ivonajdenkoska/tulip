import argparse
import ast
from open_clip.factory import DEFAULT_CONTEXT_LENGTH
...
def parse_args(args):
    ...
    parser.add_argument(
        ...
        type=int,
        help="Number of context text to use for text encoder"
    )
    parser.add_argument(
        "--student-context-length", 
        default=200,
        type=int,
        help="Number of context length to use for text encoder of the student model"
    )
    parser.add_argument(
        "--extended-context-length", 
        default=DEFAULT_CONTEXT_LENGTH * 3,
        type=int,
        help="Number of extended context length to use for text encoder"
    )
    parser.add_argument(
        "--scaling-factor", 
        default=8., # FIXME: it is based on Llama model
        type=float,
        help="Number of context text to use for text encoder"
    )
    parser.add_argument(
